...
module Y2OCI
  ...
  class ProposalStore < Installation::ProposalStore
    ...
    PROPOSAL_NAMES = ["oci_repositories_proposal", "oci_packages_proposal"]
    PROPOSAL_PROPERTIES = {
      "enable_skip" => "false"
    }
    ...
    def initialize(_unused_mode)
      ...
      super("one-click-install")
    end

    # @return [String] translated headline
    def headline
      _("One Click Install Proposal")
    end
  ...
  private
    ...
    def global_help
      _(
        "<p>\n" \
        "To start one click install, press <b>Next</b>.\n" \
        "</p>\n"
      )
    end
